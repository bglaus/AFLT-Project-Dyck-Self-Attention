...
for length in train_lengths:
    command = ['python', 'dyck_exact_layernorm.py', '--epochs', f'{num_epochs}', '--train_length', f'{length}', '--test_length', f'{length}', '--num_par', f'{num_par}',  '--depth', f'{depth}', '--shuffle', f'{shuffle}']
    foldername = 'resultsImpr1DyckLN'
