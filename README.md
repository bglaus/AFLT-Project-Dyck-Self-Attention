...
```
cd existing_repo
git remote add origin https://gitlab.ethz.ch/osaeedi/aflt-project-dyck-self-attention.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ethz.ch/osaeedi/aflt-project-dyck-self-attention/-/settings/integrations)
